...
5. Call the container something sensible (i.e. Bilingual), set the host port to 8787, and add an Environment variable called PASSWORD with the value: pass
...
git clone https://github.com/AMTdeBruin/Bilingual-switching-ageing.git
